...
class SearchMovieListPresenter: SearchMovieListPresenterProtocol {
    ...
    func selectedMovieDetails(for indexPathRow: Int) -> SelectedMovieDetailModel {
        guard let movieListArray = self.movieList else {            return SelectedMovieDetailModel(movieTitle: "Iron Man", movieReleaseYear: "2008", movieIMDBid: "tt0371746", movieType: "movie", moviePosterUrl: "https://m.media-amazon.com/images/M/MV5BMTczNTI2ODUwOF5BMl5BanBnXkFtZTcwMTU0NTIzMw@@._V1_SX300.jpg")
        }
